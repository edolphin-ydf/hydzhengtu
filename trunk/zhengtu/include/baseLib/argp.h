...
extern void(*argp_program_version_hook)(FILE * __stream,struct argp_state *__state);
...
/* Output a usage message for ARGP to STREAM.  FLAGS are from the set
   ARGP_HELP_*.  */
void argp_help(const  struct argp * __argp,FILE * __stream,unsigned __flags,char * __name);
...
void argp_state_help(const  struct argp_state * __state,FILE * __stream,unsigned int __flags);
...
/* If appropriate,print the printf string FMT and following args,preceded
   ...
   message,then exit(1).  */
void argp_error(const  struct argp_state * __state,
      const  char * __fmt,...);
...
void *argp_input(const  struct argp * __argp,const  struct argp_state * __state);
